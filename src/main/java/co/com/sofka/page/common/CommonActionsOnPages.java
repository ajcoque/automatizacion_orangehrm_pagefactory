...
public class CommonActionsOnPages {
    ...
    protected void webDriverExplicitWaitConfiguration(WebDriver driver, int seconds) {
        try {
    ...
    protected void actionMove(By opcion) {
        Actions builder = new Actions(driver);
        WebElement element = driver.findElement(opcion);
        builder.moveToElement(element).build().perform();
    }

    protected void actionMove(WebElement opcion) {
        Actions builder = new Actions(driver);
        opcion.isDisplayed();
        builder.moveToElement(opcion).build().perform();
    }
